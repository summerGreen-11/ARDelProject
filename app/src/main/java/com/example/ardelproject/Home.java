...
public class Home extends Fragment {
    ...
    int eximages[] = {R.drawable.kexpresslogo,R.drawable.hanjinexpress,R.drawable.kexpresslogo,R.drawable.koreaexpress
    ,R.drawable.kexpresslogo,R.drawable.hanjinexpress,R.drawable.koreaexpress};
